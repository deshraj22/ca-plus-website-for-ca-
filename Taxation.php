...
<div class="card">
  ...
  <div class="card">
    ...
    <div class="card-body">
      <blockquote class="blockquote mb-0">
        <p class="f2">The new Indirect Taxation regulation is based upon the system of seamless flow of the GST Credit within the entire supply chain. A taxpayer is needed to file a monthly computation of their GST and Return. On the contrary, a GST return is required to be filed on a quarterly basis for small taxpayers.</p>
     <H5 class="mt-xl-4 oh"><i class="fa fa-hand-o-right" style="font-size:30px;color:#A77B06"></i>The Various Types of GST Returns Are Mentioned as Under</H5>
        <p class="f2">GST was introduced and applied in India W.E.F 1st July 2017. More than 1.2 crores of taxpayers since then have registered for their GSTIN numbers where all the applicants are liable to file various kinds of GST Returns on the due date. Even if an inactive business has obtained registration with GST, they are required to file a GST return in the required Form. Since this is a relatively new Act in India, compliance can be confusing for former VAT and Service Taxpayers. Contact us for top to bottom GST filing solutions today.</p>
