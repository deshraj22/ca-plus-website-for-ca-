...
<html lang="en">
  ...
  <body>
  <div style="margin-top:16px"><?php include("header.php");?></div>
      <!-- content -->
    <!-- select nav tab -->
  ...
  ">
    ...
    <li><a data-toggle="tab" href="#menu4">Shop Establishment</a></li>
    <li><a data-toggle="tab" href="#menu5">NGO</a></li>
    <li><a data-toggle="tab" href="#menu6">Section-8 Company</a></li>
    <li><a data-toggle="tab" href="#menu7">Nidhi Company</a></li>
    <li><a data-toggle="tab" href="#menu8">Producer Company</a></li>
  </ul>
  ...
  <div class="tab-content">
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            <img src="IMAGES/pv2.jpg"class="d-block mx-lg-auto img-fluid im" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
            <img src="IMAGES/pv3.jpg" class="d-block mx-lg-auto img-fluid imm" alt="" width="700" height="500" loading="lazy">
          </div>
          <div class="col-lg-6">
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            <img src="IMAGES/pv4.jpg" class="d-block mx-lg-auto img-fluid im" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
            <img src="IMAGES/pv5.jpg" class="d-block mx-lg-auto img-fluid imm" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
          </div>
          <div class="col-lg-6">
            <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4"> Partnership </h1>
            <p class="lead pl" style="  text-align:justify;;
  font-family: Georgia, 'Times New Roman', Times, serif;
  font-size: 20px;
  color: #5c6873;">A Partnership firm is a business entity made by two or more people that have agreed to share the profits and losses of the business in a predetermined ratio. Partnerships are an excellent choice for conducting business for small businesses where two or more people come together to contribute to a business and share its gains or risks. Partnerships are one of the most common types of business entities found in India due to the ease of formation and minimal compliance required. The Partnership Act, of 1932 has been in motion long before India was declared an independent country. An evolved version of a partnership was brought forth by the Limited Liability Partnership or LLP in 2010.</p>
            <H5 class="mt-xl-4 h"><i class="fa fa-hand-o-right" style="font-size:30px;color:#A77B06; margin-right:5px;"></i>Types of Partnership</H5>
            <H5 class="mt-xl-4 h"><i class="fa fa-hand-o-right" style="font-size:30px;color:#A77B06 ; margin-right:5px;"></i>There are two types of Partnership</H5>
            <H5 class="mt-xl-4 h"><i class="fa fa-hand-o-right" style="font-size:30px;color:#A77B06 ; margin-right:5px;"></i>Registered Partnership</H5>
            <H5 class="mt-xl-4 h"><i class="fa fa-hand-o-right" style="font-size:30px;color:#A77B06 ; margin-right:5px;"></i>Unregistered Partnership</H5>
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            <img src="IMAGES/pv6.jpg"class="d-block mx-lg-auto img-fluid im" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
            <img src="IMAGES/pv8.jpg" class="d-block mx-lg-auto img-fluid imm" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
          </div>
          <div class="col-lg-6">
            <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4">Sole proprietorship</h1>
            <p class="lead pl zx2"></p>
            <p class="lead pl zx2">A proprietorship is a kind of unregistered business entity which is owned, managed, and controlled by only one person. The sole proprietorship business is the most commonly found business in India and is operated by the majority of the micro and small businesses present in the unorganized sector of the economy.</p>
            <p class="lead pl zx2">Sole proprietorship businesses are simple to commence and have the least amount of regulatory compliance requirements for their work. This business works the best for solitary entrepreneurs who are stepping into the business world for the first time and prefer to deal with only small businesses with a limited number of clients.</p>
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
    ...
    <!-- <div class="card">
        ...
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <p class="zx2">A proprietorship is a kind of unregistered business entity which is owned, managed, and controlled by only one person. The sole proprietorship business is the most commonly found business in India and is operated by the majority of the micro and small businesses present in the unorganized sector of the economy.</p>
            <p class="zx2">Sole proprietorship businesses are simple to commence and have the least amount of regulatory compliance requirements for their work. This business works the best for solitary entrepreneurs who are stepping into the business world for the first time and prefer to deal with only small businesses with a limited number of clients.</p>
  ...
  <div class="container col-xxl-8 px-4 py-5">
    ...
    <!-- <div class="card">
      <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4">Limited Company</h1>
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <p class="zx2">Forming a Public Limited Company is a great business decision for large-scale businesses. The minimum membership requirement is of 7 members with no limit on the maximum number of members and/or shareholders for incorporating a Public Limited Company. However, only some Public Limited Companies list with one or many stock exchanges to raise capital from the general audience. Even a Private Company can list its debt instruments on stock exchanges. Due to its structuring, Public Limited Companies are required to adhere to multiple regulations of the government. Accordingly, starting a public limited company can be a cumbersome process, and might need expert assistance.</p>
            <p class="zx2">
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            <img src="IMAGES/pv10.jpg"class="d-block mx-lg-auto img-fluid im" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
            <img src="IMAGES/pv11.jpg" class="d-block mx-lg-auto img-fluid imm" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
          </div>
          <div class="col-lg-6">
            <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4">Shop Establishment</h1>
            <p class="lead pl zx2">The registration of Shops and Establishments has been put into place so as to regulate the working and employment conditions in shops and commercial establishments across the country. This law promotes the industrial safety and welfare of the employees that work in such establishments. The Department of Labour of each state administers this law.</p>
            <p class="lead pl zx2"> The Company Registration India is an online forum that is regulated and comes under the purview of the Companies Act, 2013. The site also adheres to the guidelines set by the Ministry of Corporate Affairs (MCA) and is processed by the Registrar of Companies from the Central Registration Centre (CRC). This portal for registering companies has a web-based filing system that we can assist you to fill.</p>
            <p class="lead pl zx2">A “shop” is defined as any premise where trading or business activities are carried out, or where services are provided to the customers. An “establishment” is defined as a commercial, trading, banking, or insurance-based establishment where individuals employed are engaged primarily in office work. Subject to a few exceptions, all types of shops and establishments come under the purview of this act.</p>
            <div class="d-grid gap-2 d-md-flex justify-content-md-start">
    ...
    <!-- <div class="card">
      <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4">Shop Establishment</h1>
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <p class="zx2">The registration of Shops and Establishments has been put into place so as to regulate the working and employment conditions in shops and commercial establishments across the country. This law promotes the industrial safety and welfare of the employees that work in such establishments. The Department of Labour of each state administers this law.</p>
            <p class="zx2">A “shop” is defined as any premise where trading or business activities are carried out, or where services are provided to the customers. An “establishment” is defined as a commercial, trading, banking, or insurance-based establishment where individuals employed are engaged primarily in office work. Subject to a few exceptions, all types of shops and establishments come under the purview of this act.
            </p>
    ...
    <!-- <div class="card">
      <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4">Section-8 Company</h1>
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <p class="zx2">Any not-for-profit organization or an NGO can register itself as a trust by executing a trust deed or as a society under the Registrar of Societies, or as a not-for-profit company under Section 8 Company of the Companies Act, 2013. A Section 8 Company is a special entity and the same as a Section 25 company under The Old Companies Act, 1956. Under The New Companies Act 2013, Section 25 Companies have now been renamed as Section 8 Companies.</p>
            <p class="zx2">As per section 8(1a, 1b, 1c) of the Companies Act, 2013, “A Section 8 company can be established for the promotion of commerce, art, science, sports, education, research, social welfare, religion, charity, protection of environment or any such other object”. The Act further clarifies that the Section 8 companies can pursue the above motives, subject to the condition that it “Intends to apply the profits, if any, or other income in promoting its objects and intends to prohibit the payment of any dividend to its members”. In simpler words, a Section 8 Company has to endorse a public cause and the proceeds created by the entity have to be solely used to support the stated public cause(s).</p>
          </blockquote>
        </div>
      </div> -->
    </div>
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
          <div class="col-10 col-sm-8 col-lg-6">
            <img src="IMAGES/pv22.jpg"class="d-block mx-lg-auto img-fluid im" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
            <img src="IMAGES/pv24.jpg" class="d-block mx-lg-auto img-fluid imm" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
          </div>
          <div class="col-lg-6">
            <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4">Producer Company</h1>
            <H5 class="mt-xl-4 h ser6" id="tu" style="margin:50px 0px 0px -50px"><i class="fa fa-hand-o-right" style="font-size:30px;color:#A77B06; margin-right:13px; margin-top: 5px;"></i>Register A Producer Company in India</H5>
            <p class="lead pl zx2">The Companies Act, 2013 defines a Producer as, “Any person engaged in any activity associated with or relatable to any primary produce”. Here the term Produce means, “Things that have been produced or grown, especially by farming”. A Producer Company is a special corporate entity that has the object that is one, or all of the following:</p>
            <p class=" lead pl zx2">Production, harvesting, procurement, grading, pooling, handling, marketing, selling, export of primary produce of the shareholders, or import of goods or services for their benefit.</p>
    ...
    <!-- <div class="card">
      <h1 class="display-5 fw-bold lh-1 mb-3 hm ser4">Producer Company</h1>
       <H5 class="mt-xl-4 h ser5" style="margin:50px 0px 0px 21px"><i class="fa fa-hand-o-right" style="font-size:30px;color:#A77B06; margin-right:13px; margin-top: 5px;"></i>Register A Producer Company in India</H5>
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <p class="zx2">The Companies Act, 2013 defines a Producer as, “Any person engaged in any activity associated with or relatable to any primary produce”. Here the term Produce means, “Things that have been produced or grown, especially by farming”. A Producer Company is a special corporate entity that has the object that is one, or all of the following:</p>
            <p class="zx2">Production, harvesting, procurement, grading, pooling, handling, marketing, selling, export of primary produce of the shareholders, or import of goods or services for their benefit.</p>
          </blockquote>
        </div>
      </div> -->
    </div>
