    ...
    $user_message="Dear $name.\nWelcome to caplus/\n We have got your query.We will reach you soon.\nThank You!";
        if(mail($to,$subject,$full_message,$headers)){
           mail($user,$user_subject,$user_message,$user_headers);
            ...
            $_SESSION["response"]="<h3 style='color:#80ba26'>Dear <span class='text-info'>$name</span>,</h3><blockquote><p>Something is wrong. It seems like internet is not working well or u may have entered wrong email.<br/>For Quick Enquiry <span class='text-warning'>Call Us</span> at <a href='tel:+91 9028388889'>+91 9028388889 (FM),</a><span class='text-info'></i><i class='fa fa-whatsapp'></i><span><a href='tel:+91 9955442169'> +91 9955442169 (FM)</a></span></span></p>
            <p>Please, try again!</p><p>Thank You!</p></blockquote>";
        }
    header("Location:thanks.php");
}
